...
# from apps.analytics.simulator_views import SimulatorViewSet  # Comentado temporalmente por dependencia paho-mqtt
...
# router.register(r'simulators', SimulatorViewSet, basename='simulator')  # Comentado temporalmente
